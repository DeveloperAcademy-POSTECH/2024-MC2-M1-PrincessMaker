...
struct ContentView: View {
    ...
    @State private var newCloth = Cloth(name: "", size: "", numericalPhotoData: nil, mainPhotoData: nil, selectedSubCategory: "", selectedMainCategory: "", numericalUIImage: nil, mainUIImage: nil)
    @State private var selectedCloth: Cloth = Cloth(name: "", size: "", numericalPhotoData: nil, mainPhotoData: nil, selectedSubCategory: "", selectedMainCategory: "", numericalUIImage: nil, mainUIImage: nil)
    ...
    var body: some View {
        NavigationStack {
            VStack(alignment: .leading) {
                ...
                NavigationLink(destination: BigCategory(newCloth: $newCloth)) {
